  ...
  render() {
    return (
      <>
        ...
        <h1>WELCOME PILOT</h1>
        <h2>
          The off-world colonies need your help. A group of replicants have cut
          off supply lines and destroyed one of our transport ships. Your
          mission is to deliver critical relief supplies to Arcadia 234 and
          eliminate any replicants along the way. This uprising must be silenced
          before it gets out of hand. Time is of the essence.
        </h2>
        <br></br>
        <h1>CONTROLS:</h1>
